...
namespace ToDoListAPI.Controllers
{
    ...
    public class ToDoListController : ApiController
    {
        ...
        private static ToDoListDataAPI20161014055200 NewDataAPIClient()
        {
            var client = new ToDoListDataAPI20161014055200(new Uri(ConfigurationManager.AppSettings["toDoListDataAPIURL"]));
